...
set SYSCFG_PATH="E:\Keil\TI\sysconfig_1.28.0\sysconfig_cli.bat"
...
:: SDK root is at a fixed location (not a parent of the project)
set SDK_ROOT=E:\mspm0_sdk_2_10_00_04
